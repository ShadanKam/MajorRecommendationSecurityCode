...
public class CNE implements Programs {
    ...
    CNE() {
        programName = "Computer and Network Engineer";
    ...
    public void print() {
        ...
        System.out.println("Daily suggested hours for the degree completion in CNE: " + getHours() );
