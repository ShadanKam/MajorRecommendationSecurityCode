...
public class CSAI implements Programs {
    ...
    CSAI() {
        programName = "Computer science and artificial intelligence";
    ...
    public void print() {
        ...
        System.out.println("Daily suggested hours for the degree completion in CSAI: " +  getHours());
